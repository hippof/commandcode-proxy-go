...
### Added
- **Thinking-block signatures**: Anthropic `thinking` blocks now carry a
  synthetic signature (buffered `signature` field and streaming `signature_delta`)
  so Claude Code renders the thinking instead of dropping it as unsigned.
...
[1.4.1]: https://github.com/liwei/commandcode-proxy-go/releases/tag/v1.4.1
[1.4.0]: https://github.com/liwei/commandcode-proxy-go/releases/tag/v1.4.0
